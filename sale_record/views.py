...
class InvoiceGenerateView(View):
    def get(self, request, **kwargs):
        ...
        response = "Value -- {}".format(pk)
        download_location = PathMapping.objects.filter(category=1).last()
        try:
            ...
            file_location = os.path.join(download_location.invoice_path, file_name)
